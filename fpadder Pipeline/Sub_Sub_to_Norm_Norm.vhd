-- 6.1.4.1.3. comp3/comp0/comp2 - Sub_Sub_to_Norm_Norm.vhd
...
entity Sub_Sub_to_Norm_Norm is
    port ( Subnormal3_A   : in  STD_LOGIC_VECTOR (36 downto 0);
...
end Sub_Sub_to_Norm_Norm;

architecture Behavioral of Sub_Sub_to_Norm_Norm is

signal x_times_leftshift_s1 : STD_LOGIC_VECTOR (4 downto 0);
signal x_times_leftshift_s2 : STD_LOGIC_VECTOR (4 downto 0);

signal Mantissa_A_s, Mantissa_B_s : STD_LOGIC_VECTOR (27 downto 0);
...
Mantissa_A_s <=Subnormal3_A (27 downto 0);
exp_A_s1 <= Subnormal3_A (35 downto 28);
x_times_leftshift_s1 <= 
"00000" when Mantissa_A_s(27) = '1'                                                  
                                else --  0
...
Mantissa_B_s <=Subnormal3_B (27 downto 0);
exp_B_s1 <= Subnormal3_B (35 downto 28);
x_times_leftshift_s2 <= 
...
"-----";            
    ...
    process (Subnormal3_A,Subnormal3_B,Mantissa_A_s,Mantissa_B_s, 
             x_times_leftshift_s1, exp_A_s1, x_times_leftshift_s2, exp_B_s1)
    ...
    begin
        if Subnormal3_A /= "-------------------------------------" and 
           Subnormal3_B /= "-------------------------------------" then           
            --Shifting A
            -- 1st shift stage
            if (x_times_leftshift_s1(0)='0') then
                temp1 := Mantissa_A_s;
            else
                temp1(0) := '0';
            ...
            -- 2nd shift stage
            if (x_times_leftshift_s1(1)='0') then
                temp2 := temp1;
            else
             ...
             -- 3rd shift stage
             if (x_times_leftshift_s1(2)='0') then
                 temp3 := temp2;
             else
            ...
            -- 4th shift stage
            if (x_times_leftshift_s1(3)='0') then
                temp4 := temp3;
            else
             ...
             -- 5th shift stage
             if (x_times_leftshift_s1(4)='0') then
                shifted_A  := temp4;--
             else
            ...
            if exp_A_s1>0 then
                shifted_A_s <= Subnormal3_A (27 downto 0);
                exp_A_s2 <= exp_A_s1;
            elsif exp_A_s1=0 then
            shifted_A_s <=shifted_A; -- save variable to signal
            exp_A_s2 <= exp_A_s1 - x_times_leftshift_s1 + "1111111";
            end if;
            --Shifting B
            -- 1st shift stage
            if (x_times_leftshift_s2(0)='0') then
                temp1 := Mantissa_B_s;
            else
                temp1(0) := '0';
            ...
            -- 2nd shift stage
            if (x_times_leftshift_s2(1)='0') then
                temp2 := temp1;
            else
                for i in 0 to 1 loop
                    temp2(i) := '0';
            ...
            -- 3rd shift stage
            if (x_times_leftshift_s2(2)='0') then
                temp3 := temp2;
            else
                for i in 0 to 3 loop
                    temp3(i) := '0';
            ...
            -- 4th shift stage
            if (x_times_leftshift_s2(3)='0') then
                temp4 := temp3;
            else
                for i in 0 to 7 loop
                    temp4(i) := '0';
            ...
            -- 5th shift stage
            if (x_times_leftshift_s2(4)='0') then
                shifted_B := temp4;
            else
                for i in 0 to 15 loop
                    shifted_B(i) := '0';
            ...
            if exp_B_s1>0 then
                shifted_B_s <= Subnormal3_B (27 downto 0);
                exp_B_s2 <= exp_B_s1;
            elsif exp_B_s1=0 then
               exp_B_s2 <= exp_B_s1 - x_times_leftshift_s2 + "1111111";
               shifted_B_s <=shifted_B;                 
            end if;     
        end if;
    end process;
Norm_Norm_11_A (36) <= Subnormal3_A(36);
Norm_Norm_11_A (35 downto 28) <= exp_A_s2; -- Subnormal with increased exponent
Norm_Norm_11_A (27 downto 0) <= shifted_A_s;
Norm_Norm_11_B (36) <= Subnormal3_B(36);
Norm_Norm_11_B (35 downto 28) <= exp_B_s2; -- Subnormal with increased exponent
Norm_Norm_11_B (27 downto 0) <= shifted_B_s;
end Behavioral;
